    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        onUpdate: self => {
          ...
          orderedSliders.forEach((s, i) => gsap.set(s, { pointerEvents: i === index ? "auto" : "none" }));
...
tabs.forEach((tab, i) => {
  tab.onclick = e => {
    ...
    const tlAnim = scrollTriggerInstance.animation;
